...
-- (meet_bundle_items). This guards against a buyer stacking two bundle
-- purchases for the same meet, just in case, since that would double-expand
-- things. Only one live bundle payment per (meet, buyer) is allowed, same
-- pattern as the other live-payment guards.
-- =============================================================
