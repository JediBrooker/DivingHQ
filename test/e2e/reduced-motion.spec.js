...
// the global guard in app.css collapses every looping animation -- and
...
// non-trivial duration. Under reduced motion this must be empty.
...
test("meet-day surfaces honour prefers-reduced-motion", async ({ request, page }) => {
  ...
  // The global guard collapses even a freshly-injected infinite
  // animation to a near-zero duration.
  ...
  // Control Room -- same guarantee on the densest operator surface.
