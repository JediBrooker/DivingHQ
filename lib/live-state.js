...
// locks an event — but lets the socket layer warn a second operator (or a
// second window) that they're double-driving the same event. In-memory
// only (like activeDivers); it's transient session state, not persisted.
