...
// Kick off the recurring sweep. Only call this when payments are enabled,
// with Stripe dormant there's nothing to withdraw anyway and the settings
// endpoints already save the preference for later.
