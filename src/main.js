...
// instead of something we have to manually bust.
...
// ~500ms browser delay, this swaps it for a CSS-only ::after that
// renders on the first hover frame). Migration patterns:
...
//                never see a English flash on first paint (`en` is
